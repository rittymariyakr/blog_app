        ...
        <>
            <div style={{ width: '100%', color: 'black', boxShadow: 'initial' }} className='d-flex mt-5 align-items-center flex-column bg-primary'>
                <div className="footer w-100">
                    <div class="row mt-5 ms-5 me-2">
                        <div className="col-md-4 col-lg-3 mb-4">
                            <h5 className="mt-2 fs-4 text-light"><i class="fa-solid fa-blog text-light "></i> BLOGGER</h5>
                        ...
                        <div className="col-md-4 col-lg-3 mb-4">
                            ...
                            <div className="mt-4">
                                <p className='footer-link'><Link style={{ textDecoration: "none", color: 'white' }}>React</Link></p>
                                <p className='footer-link'><Link style={{ textDecoration: "none", color: 'white' }}>Bootswatch</Link></p>
                                <p className='footer-link'><Link style={{ textDecoration: "none", color: 'white' }}>Bootstrap</Link></p>
                                <p className='footer-link'><Link style={{ textDecoration: "none", color: 'white' }}>Material UI</Link></p>
                            </div>
                        </div>
                        <div className="col-md-4 col-lg-3 mb-4">
